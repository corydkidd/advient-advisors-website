      ...
      <section className="min-h-screen bg-navy-deep py-24">
        <div className="container">
          ...
          >
            ...
            <p className="text-cream/50 mb-12">Last updated: February 2025</p>
            ...
            <div className="prose prose-invert max-w-none space-y-8">
              ...
              {/* Data Collection */}
              <section>
                <h2 className="font-heading text-2xl font-semibold text-cream mb-4">
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-cream/80 leading-relaxed">
                  <li>
              ...
              <section>
                ...
                <div className="text-cream/80 space-y-1">
                  <p>
                    <strong className="text-cream">Advient Advisors LLC</strong>
                  </p>
                  <p>Dr. Cory Kidd</p>
              ...
              <div className="pt-8 border-t border-white/10">
                <Link
                  href="/"
                  className="text-gold hover:text-cream transition-colors duration-300"
                >
                  &larr; Back to Home
                </Link>
              </div>
